...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tracker_users', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'users.about'
        db.add_column(u'tracker_users', 'about',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=600, blank=True),
                      keep_default=False)

        # Adding field 'users.icon_url'
        db.add_column(u'tracker_users', 'icon_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=420, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'users.name'
        db.delete_column(u'tracker_users', 'name')

        # Deleting field 'users.about'
        db.delete_column(u'tracker_users', 'about')

        # Deleting field 'users.icon_url'
        db.delete_column(u'tracker_users', 'icon_url')
